      ...
      
      {
               ...
               </div>)}
               {
                ...
                /><p className="text-black-400" style={{textDecoration:'none', color:'black'}} >Linkedin</p></Link>
                  ...
                  {
                  data.communication.whatsapp!==''&& (<div>
                    <Link className="flex" target="_blank" href={data.communication.whatsapp} >
                    <AiOutlineWhatsApp
                    size={25}
                    className="cursor-pointer mx-3"
                    color="#17C964"
