    ...
    <>
          ...
          <CardBody>
            <div className="text-center">
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <Image width={200} src={data.signature}></Image>
              </div>
            </div>
          </CardBody>
        </Card>{' '}
      ...
      <div className="grid grid-cols-6 lg:grid-cols-12 px-5  gap-5">
        <Card className="col-span-6 ">
          <CardBody>
            <InformationDiv text={'Usuario'} info={data.user} />
            <InformationDiv text={'Correo Electronico'} info={data.email} />
            <InformationDiv text={'Primer Nombre'} info={data.firstName} />
            <InformationDiv text={'Nombre Familiar'} info={data.familyName} />
            <InformationDiv text={'Celular'} info={data.phone} />
            <InformationDiv text={'Ciudad'} info={data.country.code} />
          </CardBody>
        </Card>

        <Card className="col-span-6 ">
          <CardBody>
            <InformationDiv text={'Título Profesional'} info={data.jobTitle} />
            <InformationDiv
              text={'Departamento'}
            ...
            <div className="grid grid-cols-4 p-1 gap-3">
              <h3 className="text-gray-400 col-start-1 text-right">
                Aplicacion Movil
              </h3>
            ...
            <InformationDiv text={'Estado'} info={data.status} />
          </CardBody>
        </Card>
      </div>
    </>
